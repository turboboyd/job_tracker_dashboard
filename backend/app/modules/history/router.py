...
from app.modules.history.schemas import CommentRequest, HistoryItemRead, HistoryListResponse
...
async def list_history(
    ...
    items = await history_svc.list_for_application(current_user, app_id, limit=limit)
    return HistoryListResponse(items=[HistoryItemRead.model_validate(i) for i in items])
